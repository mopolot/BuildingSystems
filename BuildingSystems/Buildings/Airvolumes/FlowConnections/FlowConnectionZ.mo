...
equation
  ...
  // deltaz * der(v) = (-1/(0.5*(port_1.rho + port_2.rho)))*dP - (port_2.vVec[3]^2 - port_1.vVec[3]^2)- 0.5*(port_1.ForceVF + port_2.ForceVF);
  // with parameterization:
  deltaz * der(v) = (-1/(0.5*(port_1.rho + port_2.rho)))*dP - (port_2.vVec[3]^2 - port_1.vVec[3]^2)- 0.5*(port_1.ForceVF + port_2.ForceVF) *0.5 - 0.5 * LosFac*sign(v)*v^2*LayFacBC;
  ...
  annotation (Diagram(graphics={
    Ellipse(extent={{34,38},{-34,-30}},lineColor={0,0,255},fillColor={255,255,170},fillPattern=FillPattern.Solid),
