...
equation
  ...
  connect(wall1.toSurfacePort_1, zone.toConstructionPorts1[1]) annotation (Line(
        points={{-26,-2.22045e-016},{-20,-2.22045e-016},{-20,4},{-11,4}}, color=
         {0,0,0}));
  connect(roof.toSurfacePort_1, zone.toConstructionPorts2[1]) annotation (Line(
        points={{-2.22045e-016,26},{-2.22045e-016,20},{-2.22045e-016,16},{4,16},
          {4,11}}, color={0,0,0}));
  connect(wall2.toSurfacePort_1, zone.toConstructionPorts3[1])
    annotation (Line(points={{26,0},{20,0},{20,-4},{11,-4}}, color={0,0,0}));
  connect(floor.toSurfacePort_1, zone.toConstructionPorts4[1]) annotation (Line(
  ...
  connect(wall3.toSurfacePort_1, zone.toConstructionPorts6[1]) annotation (Line(
        points={{-18,-20},{-14,-20},{-14,-6},{-9,-6}}, color={0,0,0}));
  connect(wall4.toSurfacePort_1, zone.toConstructionPorts5[1])
  ...
  annotation(experiment(StartTime=0, StopTime=31536000),
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Buildings/Zones/Examples/SingleZoneThermal3D1x1.mos" "Simulate and plot"),
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-60,-60},{60,60}})),
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-40},{100,40}})));
end SingleZoneThermal3D1x1;
